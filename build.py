...
# 架空の会社なので、実在の住所・氏名・メールアドレスは載せない。
# それらしい番地を置くと、その住所に実在する家や店へ問い合わせが行ってしまう。
# 電話番号を未割当の番号にしてあるのと同じ理由。
# 市までは書いて番地を伏せるのは、記入漏れではなく意図した空欄だと分かるようにするため。
# 実案件では、依頼主からもらった内容に差し替える（3か所とも、ここと page-tokushoho.html）。
ZIP_DISP = "〒000-0000"
CITY_DISP = "愛知県瀬戸市"
FICTION_NOTE = "架空のサイトのため、番地は掲載していません"
FICTION_BLANK = "架空のサイトのため記載していません"
    ...
    <div class="foot__grid">
      <div>
        ...
        <address style="font-style:normal">
          {ZIP_DISP}　{CITY_DISP}<br>
          <small>※ {FICTION_NOTE}</small><br>
